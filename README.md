...
@st.cache_data(ttl=60)  # Cache 60 giây để tránh lỗi rate limit
...
if data.empty or 'Close' not in data.columns:
    st.error("❌ Không lấy được dữ liệu coin. Thử lại coin khác hoặc chờ 30 giây rồi refresh.")
    st.stop()
...
st.caption("Dữ liệu realtime • Không phải lời khuyên đầu tư • Đã fix lỗi KeyError • Code by Grok 2026")
